...
from bikeshed.exceptions import DocumentDoesNotExist, ReferenceLookupError
from bikeshed.documents import parse_document
...
class BaseDocumentStore(object):
    ...
    def __init__(self, redis=None, es=None, default_type=None, default_project=None, index_name='bikeshed'):
        self.redis = redis
        self.es = es
